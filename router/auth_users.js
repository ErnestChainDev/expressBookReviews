...
let users = [];   // will hold registered users {username, password}

// Check if the username is valid (exists and not already taken)
const isValid = (username) => {
    // username must be a non-empty string and not already in the users array
